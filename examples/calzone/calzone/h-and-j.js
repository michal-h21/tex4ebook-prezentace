...
var formatter = function (measureText, options) {
	...
	return {
		center: function (text) {
			...
			nodes.push(linebreak.glue(0, 2, 0));
			...
			words.forEach(function (word, index, array) {
				...
				if (index === array.length - 1) {
					...
					nodes.push(linebreak.glue(spaceWidth, -4, 0));
					nodes.push(linebreak.box(0, ''));
					nodes.push(linebreak.penalty(0, linebreak.defaults.infinity, 0));
					nodes.push(linebreak.glue(0, 2, 0));
				}
		...
		justify: function (text) {
			...
			words.forEach(function (word, index, array) {
                hyphenator.hyphenate(word).forEach(function (x, index, array) {
                    nodes.push(linebreak.box(measureText(x), x));
                    if (index != array.length-1) {
                        nodes.push(linebreak.penalty(0, linebreak.defaults.hyphenpenalty, 1));
                    }
                });
